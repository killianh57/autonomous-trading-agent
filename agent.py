...
def _log_to_notion(trade):
    ...
    try:
        requests.patch(
            f"[https://api.notion.com/v1/blocks/](https://api.notion.com/v1/blocks/){NOTION_PAGE_ID}/children",
...
def get_news_sentiment(ticker):
    ...
    try:
        ...
        r = requests.get("[https://newsapi.org/v2/everything](https://newsapi.org/v2/everything)", params=params, timeout=8)
...
def process_commands():
    ...
    try:
        r = requests.get(
            f"[https://api.telegram.org/bot](https://api.telegram.org/bot){TELEGRAM_TOKEN}/getUpdates",
